...
public class SkinnableComponent extends UIComponent
{
     ...
     *  @productversion Flex 4
     */
    public function SkinnableComponent(statable:Boolean = true, stylable:Boolean = true)
    {
        super(statable, stylable)
    ...
    override protected function commitProperties():void
    {
        ...
        if (skinStateIsDirty)
        {
			...
			mx_internal::stateChanged(skin.currentState, pendingState, false);
